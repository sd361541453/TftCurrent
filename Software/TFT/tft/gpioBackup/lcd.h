...
//SPI显示屏接口
//LCD_RST
#define SPILCD_RST_SET  GPIO_HIGH(LCD_REST)
#define SPILCD_RST_RESET GPIO_LOW(LCD_REST)
//LCD_RS//dc
#define SPILCD_RS_SET  GPIO_HIGH(LCD_DC)
#define SPILCD_RS_RESET  GPIO_LOW(LCD_DC)
//LCD_CS
#define SPILCD_CS_SET GPIO_HIGH(LCD_CS)
#define SPILCD_CS_RESET  GPIO_LOW(LCD_CS)
